...
public class CitiesAdapter extends RecyclerView.Adapter<CitiesAdapter.MyViewHolder> {
    ...
    public CitiesAdapter(Context mContext, List<City> albumList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.count.setText(album.getNumOfSongs() + " City");
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            switch (menuItem.getItemId()) {
                case R.id.action_add_favourite:
                    Toast.makeText(mContext, "Save City", Toast.LENGTH_SHORT).show();
                    return true;
                case R.id.action_play_next:
                    Toast.makeText(mContext, "Search job", Toast.LENGTH_SHORT).show();
                    return true;
                default:
            }
            return false;
